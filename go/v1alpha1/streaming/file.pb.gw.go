...
func RegisterFileServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server FileServiceServer) error {
	...
	mux.Handle("POST", pattern_FileService_CreateFile_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/proto.streaming.v1alpha1.FileService/CreateFile", runtime.WithHTTPPathPattern("/_streaming/v1/files"))
		if err != nil {
...
func RegisterFileServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client FileServiceClient) error {
	...
	mux.Handle("POST", pattern_FileService_CreateFile_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/proto.streaming.v1alpha1.FileService/CreateFile", runtime.WithHTTPPathPattern("/_streaming/v1/files"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_FileService_CreateFile_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"_streaming", "v1", "files"}, ""))
)
